...
mixin _$User {
 ...
 String get id; String get nickname; String? get avatarUrl; String? get email; List<AuthProvider> get providers;
...
@override
String toString() {
  return 'User(id: $id, nickname: $nickname, avatarUrl: $avatarUrl, email: $email, providers: $providers)';
}
...
@useResult
$Res call({
 String id, String nickname, String? avatarUrl, String? email, List<AuthProvider> providers
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String nickname,  String? avatarUrl,  String? email,  List<AuthProvider> providers)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String nickname,  String? avatarUrl,  String? email,  List<AuthProvider> providers)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.id,_that.nickname,_that.avatarUrl,_that.email,_that.providers);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String nickname,  String? avatarUrl,  String? email,  List<AuthProvider> providers)?  $default,) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.nickname,_that.avatarUrl,_that.email,_that.providers);case _:
  return null;
...
class _User implements User {
  const _User({required this.id, required this.nickname, this.avatarUrl, this.email, List<AuthProvider> providers = const []}): _providers = providers;
...
@override@JsonKey() List<AuthProvider> get providers {
